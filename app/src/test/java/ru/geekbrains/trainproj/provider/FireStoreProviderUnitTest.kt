package ru.geekbrains.trainproj.provider
...
class FireStoreProviderUnitTest {
    ...
    fun setup() {
        ...
        every { mockDocument1.toObject(Note::class.java) } returns testNotes[1]
        every { mockDocument1.toObject(Note::class.java) } returns testNotes[2]
    }
    ...
    @Test
    fun `saveNote return succes note`() {
